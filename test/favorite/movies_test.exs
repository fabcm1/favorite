defmodule Favorite.MoviesTest do
  ...
  describe "movies" do
    ...
    import Favorite.MoviesFixtures

    @invalid_attrs %{poster_url: nil, title: nil}
    ...
    test "create_movie/1 with valid data creates a movie" do
      valid_attrs = %{poster_url: "some poster_url", title: "some title"}
    ...
    test "update_movie/2 with valid data updates the movie" do
      movie = movie_fixture()
      update_attrs = %{poster_url: "some updated poster_url", title: "some updated title"}
