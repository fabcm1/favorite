defmodule FavoriteWeb.Router do
  use FavoriteWeb, :router

  import FavoriteWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {FavoriteWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: FavoriteWeb.Telemetry
    end
  end
