...
Accounts.register_user(%{name: "User A", email: "aaa@acbd.com", login: "userA", password: "senha00A"})
Accounts.register_user(%{name: "User B", email: "bbb@acbd.com", login: "userB", password: "senha00B"})
Accounts.register_user(%{name: "User C", email: "ccc@acbd.com", login: "userC", password: "senha00C"})
